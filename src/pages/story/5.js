...
export default props => (
  <Chapter title="The One With The Vows">
    ...
    <p>Shiya,</p>
    <p>
      I am so incredibly happy about our every time together. I am so aware how
      we always move forward in our relationship, how it moves us along, and one
      great step each time. And now one can see ever more clearly and with
      certainty how likely it is that we will reach all that one possibly can
      reach.
    </p>
    <p>
      ...
      will get it too. I think I am only able to help by loving you so much that
      you soon believe it in the deepest reaches of your own heart.
    </p>
    <p>
